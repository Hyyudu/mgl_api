...
from handlers.ApiHandler import ApiHandler, DefaultHandler, LogsHandler, SyncFileHandler, DemetreusFlightsHandler
...
app_urls = [
    ...
    url('/mcc/skip_flight', skip_flight),
    ...
    ("/get_flight_for_Demetreus", DemetreusFlightsHandler),
